// Vendored from the @evilcharts shadcn registry (see components.json) — do not
// hand-edit. Re-pull via `npx shadcn add @evilcharts/<name>` instead.
    ...
    >
      {payload
        ...
        .map((item) => {
          ...
          // Only legends with a real selection handler are interactive — render
          // those as a real <button> so they're keyboard-operable, and a plain
          // <div> otherwise rather than attaching dead click semantics to it.
          return isClickable ? (
            <button
              key={key}
              type="button"
