        ...
        <div className="flex items-center gap-1 px-1 py-1">
          <DropdownMenu>
            <DropdownMenuTrigger className="flex min-w-0 flex-1 items-center gap-1.5 rounded-md px-1.5 py-1 hover:bg-sidebar-accent">
              ...
              <HugeiconsIcon icon={ArrowDown01Icon} strokeWidth={1.5} className="ml-auto size-2.5 text-sidebar-foreground/60" />
            </DropdownMenuTrigger>
            <DropdownMenuContent align="start">
              <DropdownMenuItem render={<Link href="/design-system" />}>Design system</DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          <Link
            href="/traces"
